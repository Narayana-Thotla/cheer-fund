...
const Dashboard = () => {
  ...
  // console.log("sessgion in dashboard:", session);
  ...
  // console.log("data inside dash:", session.user.email);
      ...
      <div>
        ...
        <div>
          ...
          <div className="text-center mt-5">
            <button
              onClick={() => {
                router.push(`dashboard/edit/${userData.username}`);
              }}
              type="button"
        ...
        <Payments  sender_email={`${session.user.email}`} />
        </div>
      </div>
    </div>
  ) : (
